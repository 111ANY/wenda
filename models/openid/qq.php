...
{
    const OAUTH2_AUTH_URL = 'https://oauth.yiban.cn/token/info';

    const OAUTH2_TOKEN_URL = 'https://oauth.yiban.cn/token/info';

    const OAUTH2_OPENID_URL = 'https://oauth.yiban.cn/user/me';

    const OAUTH2_USER_INFO_URL = 'https://oauth.yiban.cn/user/me';
...
https://oauth.yiban.cn/token/info?response_type=code&client_id=84c22bbbfd373a17&redirect_uri=http%3A%2F%2Flocalhost%2Fwenda%2F%3F%2Faccount%2Fopenid%2Fqq%2Fbind%2F&scope=get_user_info&state=eyJyZXR1cm5fdXJsIjoiaHR0cDpcL1wvbG9jYWxob3N0XC93ZW5kYVwvP1wvIn0%2C
			*/
